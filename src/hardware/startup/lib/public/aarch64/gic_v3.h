/*
 * $QNXLicenseC:
 * Copyright 2016-2025, BlackBerry Limited.
...
#define ARM_GICD_TYPER_ESPI_RANGE       (1U << 27)
#define ARM_GICD_TYPER_RSS              (1U << 26)
#define ARM_GICD_TYPER_NO1N             (1U << 25)
#define ARM_GICD_TYPER_A3V              (1U << 24)
#define ARM_GICD_TYPER_ID               (1U << 19)
#define ARM_GICD_TYPER_DVIS             (1U << 18)
#define ARM_GICD_TYPER_LPIS             (1U << 17)
#define ARM_GICD_TYPER_MBIS             (1U << 16)
#define ARM_GICD_TYPER_NUM_LPIS         (1U << 11)
#define ARM_GICD_TYPER_SEC_EXTN         (1U << 10)
#define ARM_GICD_TYPER_ESPI             (1U << 8)
#define ARM_GICD_TYPER_CPU_NUM          (1U << 5)
#define ARM_GICD_TYPER_CPU_IT_LINE_NUM  (1U << 0)
...
#define ARM_GICC_CTLR_EL1_EXT_RANGE     (1UL << 19)
#define ARM_GICC_CTLR_EL1_RSS           (1UL << 18)
#define ARM_GICC_CTLR_EL1_A3V           (1UL << 15)
#define ARM_GICC_CTLR_EL1_SEIS          (1UL << 14)
#define ARM_GICC_CTLR_EL1_ID            (1UL << 11)
#define ARM_GICC_CTLR_EL1_PRI           (1UL << 8)
#define ARM_GICC_CTLR_EL1_PMHE          (1UL << 6)
#define ARM_GICC_CTLR_EL1_EOI           (1UL << 1)
#define ARM_GICC_CTLR_EL1_CBPR          (1UL << 0)
